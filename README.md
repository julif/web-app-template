...
- [x] Detectar idioma
- [x] detectar tama�o de dispositivo
...
* **[v 0.2]** `2019-10-10`   
 - `added` detecta el tama�o de desktop tablet smartphone landsace y portrait.
* **[v 0.1]** `2019-10-10` 
 - `added` filtro de Idioma,y solo el filtro para el idioma espa�ol con el ingles como default.
